#
#  Be sure to run `pod spec lint DJScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of DJScrollView in Markdown format.
  ...
  # s.exclude_files = "DJScrollView/Exclude"
